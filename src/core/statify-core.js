...
var statify = (function (root) {
	...
	core.buildStatesContext = (function (core) {
		...
		/**
		 * build a statesContext object from DOM states attributes declarations : data-states-*
		 */
		...
		return function ($el, options) {
			...
			statesContext.names = options.names || $el.attr(_config.stateAttr);
			...
			//sets the initial state for the container: by default the firs in the list
			...
			statesContext.elements = _.isObject(options.elements) ? options.elements : _fromDOM($el, options);
